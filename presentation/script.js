...
function setupValueSection(pixels) {
  ...
  const copyByState = [
    "אם היו מבקשים מאיתנו לכתוב תוכנית שמקבלת רשת של 28×28 פיקסלים,<br>ומחזירה מספר אחד בין 0 ל־9, משימה שנראית כמעט טריוויאלית הופכת מיד לקשה מאוד.",
    "וזה קורה משום שמבחינת המחשב זו בכלל לא ספרה.<br>זו רק מטריצה של 784 ערכים בין 0 ל־1, שכל אחד מהם מתאר את עוצמת האפור של פיקסל אחד.",
    "איכשהו המוח שלנו מזהה ספרות כמעט בלי מאמץ, אבל קשה מאוד להסביר את זה כסדרה של ifים, לולאות ופונקציות.<br>תכנות רגיל פשוט לא מרגיש כמו הכלי הנכון כדי לפתור בעיה כזאת.",
  ];
  const labelByState = [
